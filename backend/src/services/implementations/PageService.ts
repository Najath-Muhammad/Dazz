...
export class PageService implements IPageService {
  ...
  async getAllPages() {
    try {
      ...
      return { success: true, message: 'Pages retrieved successfully', data: items };
    } catch (error: any) {
  ...
  async getPageById(id: string) {
    try {
      ...
      return { success: true, message: 'Page retrieved successfully', data: item };
    } catch (error: any) {
  ...
  async createPage(data: any) {
    try {
      ...
      return { success: true, message: 'Page created successfully', data: newItem };
    } catch (error: any) {
  ...
  async updatePage(id: string, data: any) {
    try {
      ...
      return { success: true, message: 'Page updated successfully', data: updatedItem };
    } catch (error: any) {
