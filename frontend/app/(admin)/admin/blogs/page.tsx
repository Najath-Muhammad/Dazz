      ...
      render: (blog) => (
        <div className="relative">
          <button
            ...
            onClick={(e) => { e.stopPropagation(); setOpenDropdown(openDropdown === blog._id ? null : blog._id); }}
          ...
          {openDropdown === blog._id && (
            <div className="absolute right-0 bottom-full mb-1 w-48 bg-white rounded-md shadow-lg border border-slate-200 z-[100] py-1 flex flex-col text-left">
              ...
              <Link href={`/admin/blogs/${blog._id}`} className="px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 flex items-center gap-3 transition-colors">
