...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col md:flex-row">
      {/* Sidebar */}
      <aside className="w-full md:w-64 bg-dazz-navy text-white flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/admin/contacts" className="block px-4 py-3 text-[15px] font-semibold text-slate-200 hover:bg-white/10 hover:text-white rounded-lg transition-all duration-200">
            Contact Messages
          </Link>
        </nav>
