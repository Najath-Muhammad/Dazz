        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-5 space-y-12 bg-dazz-navy text-white p-10 md:p-14 rounded-lg shadow-2xl shadow-dazz-navy/20 relative overflow-hidden">
              ...
              <div className={`space-y-8 relative z-10 ${isAr ? 'text-right' : ''}`}>
                <div className="group">
                  <h4 className={`text-xs font-bold tracking-widest text-dazz-gold mb-2 flex items-center gap-2 ${isAr ? 'flex-row-reverse font-arabic uppercase-none' : 'uppercase'}`}>
                    <MapPin size={15} /> {isAr ? 'المقر الرئيسي' : 'Headquarters'}
                  </h4>
                  <p className={`text-sm md:text-base font-normal text-slate-200 group-hover:text-white transition-colors leading-relaxed whitespace-pre-wrap ${isAr ? 'font-arabic' : ''}`}>
                    {address}
                  </p>
                </div>
                ...
                <div className="group">
                  <h4 className={`text-xs font-bold tracking-widest text-dazz-gold mb-2 flex items-center gap-2 ${isAr ? 'flex-row-reverse font-arabic uppercase-none' : 'uppercase'}`}>
                    <Phone size={15} /> {isAr ? 'اتصل بنا' : 'Call Us'}
                  </h4>
                  <a href={`tel:${phone.replace(/\s+/g, '')}`} dir="ltr" className={`inline-block text-sm md:text-base font-normal text-slate-200 group-hover:text-white hover:underline transition-colors ${isAr ? 'font-arabic' : ''}`}>
                    {phone}
                  </a>
                </div>
                ...
                <div className="group">
                  <h4 className={`text-xs font-bold tracking-widest text-dazz-gold mb-2 flex items-center gap-2 ${isAr ? 'flex-row-reverse font-arabic uppercase-none' : 'uppercase'}`}>
                    <Mail size={15} /> {isAr ? 'راسلنا' : 'Email Us'}
                  </h4>
                  <a href={`mailto:${email}`} className="inline-block text-sm md:text-base font-normal text-slate-200 group-hover:text-white hover:underline transition-colors break-all">
                    {email}
                  </a>
                </div>
              </div>
