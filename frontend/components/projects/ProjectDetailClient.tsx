    ...
    <main dir={dir} className="bg-white selection:bg-dazz-gold selection:text-slate-900">
      ...
      <section className="relative h-screen min-h-[700px] flex items-end overflow-hidden bg-slate-950">
        ...
        <div className="absolute top-8 left-8 z-20">
          <Link href={`/${lang}/projects`} className="group flex items-center gap-3 text-white/70 hover:text-white transition-colors">
            ...
            <span className="text-xs font-bold tracking-widest uppercase">{isAr ? 'العودة للمشاريع' : 'Back to Projects'}</span>
          </Link>
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-24 md:pb-32">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white uppercase tracking-tighter leading-tight mb-8">
              {title}
            </h1>
          </motion.div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className="w-full lg:w-1/3 shrink-0">
              <div className="bg-white p-10 border border-slate-200 sticky top-32">
                <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-slate-400 mb-8">
                ...
                <div className="space-y-6">
                  {category && (
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-xs font-mono text-slate-400 uppercase tracking-widest mb-1">{isAr ? 'القطاع' : 'DIVISION'}</p>
                        <p className="text-lg font-bold text-slate-900 uppercase">{category}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {location && (
                    <div className="flex items-start gap-4 pt-6 border-t border-slate-100">
                      ...
                      <div>
                        <p className="text-xs font-mono text-slate-400 uppercase tracking-widest mb-1">{isAr ? 'الموقع' : 'LOCATION'}</p>
                        <p className="text-lg font-bold text-slate-900 uppercase">{location}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {year && (
                    <div className="flex items-start gap-4 pt-6 border-t border-slate-100">
                      ...
                      <div>
                        <p className="text-xs font-mono text-slate-400 uppercase tracking-widest mb-1">{isAr ? 'السنة' : 'YEAR'}</p>
                        <p className="text-lg font-bold text-slate-900 uppercase">{year}</p>
                      </div>
                    </div>
                  )}
                </div>
      ...
      <section className="py-24 md:py-32 bg-white text-center border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-extrabold uppercase tracking-tighter text-slate-900 mb-6">
          ...
          <Link 
            href={`/${lang}/contact`}
            className="inline-block px-10 py-5 bg-slate-950 text-white font-bold tracking-widest text-sm uppercase hover:bg-dazz-gold transition-colors"
          >
