  ...
  return (
    <section className="py-24 md:py-40 bg-white text-center" aria-label="Call to Action">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <span className="text-[120px] font-extrabold text-slate-100 leading-none tracking-tighter block mb-6">07</span>
          <div className="w-12 h-px bg-dazz-navy mx-auto mb-12" />
          
          <h2 className="text-4xl md:text-6xl lg:text-[80px] font-extrabold uppercase tracking-tighter text-slate-900 mb-8 leading-tight">
          ...
          <p className="text-lg md:text-xl text-slate-500 font-light mb-12 max-w-2xl mx-auto">
            {isAr 
