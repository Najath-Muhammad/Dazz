      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          <div className="lg:w-1/3">
            <span className="text-[120px] font-extrabold text-slate-200/60 leading-none tracking-tighter block mb-6">04</span>
            <div className="w-12 h-px bg-dazz-gold mb-4" />
            <h2 className="text-4xl md:text-5xl font-extrabold uppercase tracking-tighter text-slate-900 mb-6">
          ...
          <div ref={ref} className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-12">
            {claims.map((claim, i) => (
              <motion.div
                ...
                className="relative pl-8 border-l border-slate-200 hover:border-dazz-gold transition-colors duration-300"
              >
                <span className="absolute -left-[1px] top-0 w-[2px] h-0 bg-dazz-gold transition-all duration-500 group-hover:h-full" />
                <div className="text-2xl font-mono text-slate-300 mb-4">{claim.id}</div>
                <h3 className="text-xl font-bold uppercase tracking-widest text-slate-900 mb-3">
